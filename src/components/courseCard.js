...
const CourseCard = () => {
  ...
  return (
    <>
      <h1 className="text-4xl m-2 p-2 flex justify-center items-center m-2">
        Courses
      </h1>
...
=======
              ...
              />
              <div className="flex justify-start text-2xl m-2">
                {" "}
                <u>{course.title} </u>
              </div>
              <div className="flex flex-row">
              ...
              <div className="flex flex-row justify-start items-center">
                <div className="text-2xl m-1 p-2 bg-blue-100 rounded">
                  Class Size
                </div>
                <div className="text-2xl m-1">{course.classSize}</div>
              </div>
>>>>>>> 4c95441357d87bf856da5321f99cf8ca64fb25f2
            </div>
          </div>
        ))}
        Testing Complete
